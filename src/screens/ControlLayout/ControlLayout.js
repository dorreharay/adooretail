  ...
  const [tabs] = useState({
    'Основні': [
      ...
      },
      {
        ...
        component: <View style={{ flex: 1, backgroundColor: 'orange' }}></View>,
      },
      {
        index: 2,
        title: 'Банк ідей',
      ...
      },
      {
        ...
        component: <View style={{ flex: 1, backgroundColor: 'yellow' }}></View>,
      },
      {
        index: 5,
        title: 'Девайси',
        ...
        component: <View style={{ flex: 1, backgroundColor: 'green' }}></View>,
      },
      {
        index: 6,
        title: 'Фідбек',
        ...
        component: <View style={{ flex: 1, backgroundColor: 'coral' }}></View>,
      },
    ],
    'Налаштування': [
      {
